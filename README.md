...
The system allows the management of essential information, including the registration and listing of customers, suppliers, sellers, products in stock, and sales records. It also includes features for deleting records and organizing data through relationships between database tables, ensuring greater data integrity and consistency.

The application is integrated directly with the database using MySQL Connector/Python, enabling efficient execution of operations such as data insertion, querying, and manipulation.

The interface was built with HTML, CSS, and Bootstrap, aiming to provide simple and intuitive navigation. The system includes a sidebar menu for accessing functionalities, as well as a top bar (topbar) with the application title and a “Back” navigation button, improving the user experience.

As an additional feature, a dynamic search functionality was implemented in the tables using JavaScript, allowing users to find records in real time. Suggestions are displayed automatically as the user types, and when a result is selected, the system highlights the corresponding item in the table, making navigation easier.

The main goal of this project is to facilitate inventory control and organization in a practical way, centralizing important information and supporting business management in a simple and efficient manner.
